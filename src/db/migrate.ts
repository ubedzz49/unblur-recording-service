...
// distinct tracking table and lock id from every other service sharing this RDS instance --
// user-service (7264991), matching-service (7264992), doubt-service (7264993),
// resolution-service (7264994), payment-service (7264995) -- must never collide
const TRACKING_TABLE = "recording_service_schema_migrations";
const MIGRATION_LOCK_ID = 7264996;
